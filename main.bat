...
echo.                                                                       
echo.                                                                       
@echo              d88888b d888888b d8b   db d8888b. d88888b d8888b.       
@echo              88'       `88'   888o  88 88  `8D 88'     88  `8D       
@echo              88ooo      88    88V8o 88 88   88 88ooooo 88oobY'       
@echo              88~~~      88    88 V8o88 88   88 88~~~~~ 88`8b         
@echo              88        .88.   88  V888 88  .8D 88.     88 `88.       
@echo              YP      Y888888P VP   V8P Y8888D' Y88888P 88   YD       
echo.                                                                       
